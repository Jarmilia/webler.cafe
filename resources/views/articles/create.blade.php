...
@section('content')
  <div class="createArt">
    ...
    <div class="form-group">
      ...
      {{Form::label('hashtags', 'Hashtags', ['class' => 'fontSize1-3rem text-gold bold margin-top1'])}}
    ...
    <div class="form-group">
      {{Form::label('cover_image', 'Bild hochladen', ['class' => 'fontSize1-3rem text-gold bold margin-top1'])}}
